...
| Software | [MOS 1.1](../MOS-1) monitor (resident line assembler, disk filesystem, run-by-name) + EDIT, a disk-loaded editor/assembler with labels |
...
- The OS and EDIT live in [~/dev/MOS-1](../MOS-1); the cross assembler (`msap-asm --isa msap2`) lives in [~/dev/8-bit_CPU_Programmer](../8-bit_CPU_Programmer).
